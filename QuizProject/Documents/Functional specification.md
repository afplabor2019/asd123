...
![As we can see, the teacher has got a lot of work.](https://github.com/afplabor2019/asd123/blob/master/QuizProject/Images/cd.jpg)
## Required business use cases model
As we can see, the teacher has less tasks, thanks to the system.
![Required business use cases model UML](https://github.com/afplabor2019/asd123/blob/master/QuizProject/Images/funkSpecRequired.png)
...
## Wireframe
![Picture of the Tests menu](https://github.com/afplabor2019/asd123/blob/master/QuizProject/Images/wireframeTests.png)
