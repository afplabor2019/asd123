...
![As we can see, the teacher has got a lot of work.](cd.jpg)
## Required business use cases model
As we can see, the teacher has less tasks, thanks to the system.
![Required business use cases model UML](funkSpecRequired.png)
...
## Wireframe
![Picture of the Tests menu](wireframeTests.png)
